...
var connectDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    var uri, dbName, conn, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                uri = env_1.ENV.MONGODB_URI || process.env.MONGODB_URI;
                dbName = env_1.ENV.MONGODB_NAME || process.env.MONGODB_NAME || 'api';
                if (!uri) {
            ...
            case 3:
                error_1 = _a.sent();
                console.error("\u274C [DB] Falha na conex\u00E3o com Mongoose: ".concat(error_1.message));
                throw error_1;
