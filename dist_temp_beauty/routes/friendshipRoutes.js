...
router.post('/', async (req, res) => {
    try {
        ...
        await Promise.all((0, activityHelpers_1.pushRecentActivityForUsers)([userId1, userId2], { action: 'friend_added', resource: 'social_interaction', endpoint: '/api/friends' }));
...
router.delete('/:id', async (req, res) => {
    try {
        ...
        await Promise.all((0, activityHelpers_1.pushRecentActivityForUsers)([friendship.userId1, friendship.userId2], { action: 'friend_removed', resource: 'social_interaction', endpoint: '/api/friends/:id' }));
        // Notificar ambos os usuários via WebSocket
        const io = req.app.get('io');
        if (io) {
...
router.get('/check/:userId1/:userId2', async (req, res) => {
    try {
        ...
        await (0, activityHelpers_1.pushRecentActivity)(userId1, {
