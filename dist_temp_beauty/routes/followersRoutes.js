...
router.post('/', async (req, res) => {
    try {
        ...
        await (0, activityHelpers_1.pushRecentActivity)(followerId, {
            action: 'follow',
        ...
        await (0, activityHelpers_1.pushRecentActivity)(followingId, {
            action: 'followed_by',
            resource: 'social_relation',
            endpoint: '/api/followers'
        });
...
router.delete('/:id', async (req, res) => {
    try {
        ...
        try {
            (0, WebhookBroadcasterService_1.emitWebhook)('LiveGo.CallbackAfterUnfollow', { FollowerId: follow.followerId, FollowedId: follow.followingId, Timestamp: Date.now() });
        }
        catch (e) {
