...
router.post('/order', fraudDetection_1.default.detectFraud, async (req, res) => {
    try {
...
router.post('/pix', fraudDetection_1.default.detectFraud, async (req, res) => {
    try {
...
router.post('/credit-card', fraudDetection_1.default.detectFraud, async (req, res) => {
    try {
