...
const BattleSchema = new mongoose_1.Schema({
    streamerA: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true },
    streamerB: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true },
...
exports.Battle = mongoose_1.default.model('Battle', BattleSchema);
